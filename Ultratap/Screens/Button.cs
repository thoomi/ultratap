...
namespace Ultratap
{
    ...
    class Button
    {
        ...
        /// </summary>
        public Vector2 Size = new Vector2(250, 65);
        ...
        /// </summary>
        public Color FillColor = new Color(0, 0, 0) * .70f;
    ...
    /// <summary>
    /// Represents a touchable texture based button.
    /// </summary>
    class TextureButton
    {
        /// <summary>
        /// The texture representing the button
        /// </summary>
        ...
        /// Creates a new Button.
        /// </summary>
        /// <param name="text">The filepath to the buttons texture.</param>
        public TextureButton(Texture2D texture, Vector2 position)
        {
        ...
        public bool HandleTap(Vector2 tap)
        {
            if (tap.X >= Position.X &&
                tap.Y >= Position.Y &&
                tap.X <= Position.X + Texture.Width &&
                tap.Y <= Position.Y + Texture.Height)
            {
                OnTapped();
                return true;
            }
