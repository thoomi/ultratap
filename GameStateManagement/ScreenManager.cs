...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        void musicManager_PlaybackFailed(object sender, EventArgs e)
        {
        ...
        void musicManager_PromptGameHasControl(object sender, EventArgs e)
        {
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = content.Load<Texture2D>("gameElements/blank");

            gameMusic = content.Load<Song>("sounds/iron-man");
        ...
        {
            spriteBatch.Begin();
            spriteBatch.Draw(blankTexture, GraphicsDevice.Viewport.Bounds, Color.Black * alpha * 1.8f);
            spriteBatch.End();
        }
